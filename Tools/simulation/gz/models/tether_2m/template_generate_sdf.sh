...
K="#K"              # e.g. 2 → every 2nd joint
OFFSET="#OFFSET"    # e.g. 2 → start from joint 2 (so 2,4,6,…)

JOINT1_K_DAMPING="#JOINT1_K_DAMPING"
JOINT1_K_FRICTION="#JOINT1_K_FRICTION"
JOINT1_K_SPRING_REFERENCE="#JOINT1_K_SPRING_REFERENCE" #"#JOINT1_K_SPRING_REFERENCE_ALT"
JOINT1_K_SPRING_STIFFNESS="#JOINT1_K_SPRING_STIFFNESS"

JOINT2_K_DAMPING="#JOINT2_K_DAMPING"
JOINT2_K_FRICTION="#JOINT2_K_FRICTION"
JOINT2_K_SPRING_REFERENCE="#JOINT2_K_SPRING_REFERENCE" #"#JOINT2_K_SPRING_REFERENCE_ALT"
JOINT2_K_SPRING_STIFFNESS="#JOINT2_K_SPRING_STIFFNESS"
