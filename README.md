A for of the PX4-Autopilot project so that it can be modified and added as a submodule of the repository: https://github.com/hmer101/multi_drone_slung_load_master/tree/main.
